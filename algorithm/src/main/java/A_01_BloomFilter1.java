 ...
 * 3.假阳性计算
 */
public class A_01_BloomFilter1<E> {
     ...
     * @param k
     */
    public A_01_BloomFilter1(double c, int n_max, int k) {
        this.n_max = n_max;
        this.k = k;
        this.c = c;
    ...
    public A_01_BloomFilter1(int m,int n_max,int k){
        this.n_max = n_max;
        this.k = k;
        this.m = m;
        this.c = 1.0d * m / n_max;
     ...
     * @param n_max
     */
    public A_01_BloomFilter1(int m, int n_max) {
        this(m / (double) n_max,
                n_max,
     ...
     * @param n_max
     */
    public A_01_BloomFilter1(double fpp, int n_max) {
