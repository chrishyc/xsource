...
##过半机制
![](.z_03_分布式_服务注册中心_02_zookeeper_01_ZAB共识算法_过半机制_初始选举_崩溃恢复_广播消息_images/88d5c584.png)
```asp
...
```
##写请求
![](.z_03_分布式_服务注册中心_02_zookeeper_01_ZAB共识算法_过半机制_初始选举_崩溃恢复_广播消息_images/dc4506a6.png)
...
#服务运行期间的选举(崩溃恢复)
![](.z_03_分布式_服务注册中心_02_zookeeper_01_ZAB共识算法_过半机制_初始选举_崩溃恢复_广播消息_images/609b7a20.png)
