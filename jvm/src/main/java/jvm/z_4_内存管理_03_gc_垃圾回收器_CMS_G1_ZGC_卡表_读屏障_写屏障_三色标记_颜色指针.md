...
垃圾回收器搭配
![](.z_4_内存管理_03_gc_垃圾回收器_CMS_G1_ZGC_卡表_读屏障_写屏障_三色标记_颜色指针_images/0bcd810b.png)
CMS
![](.z_4_内存管理_03_gc_垃圾回收器_CMS_G1_ZGC_卡表_读屏障_写屏障_三色标记_颜色指针_images/30df709b.png)
G1
![](.z_4_内存管理_03_gc_垃圾回收器_CMS_G1_ZGC_卡表_读屏障_写屏障_三色标记_颜色指针_images/d0981227.png)
G1 gc
![](.z_4_内存管理_03_gc_垃圾回收器_CMS_G1_ZGC_卡表_读屏障_写屏障_三色标记_颜色指针_images/8b0cdd30.png)
G1 回收过程
![](.z_4_内存管理_03_gc_垃圾回收器_CMS_G1_ZGC_卡表_读屏障_写屏障_三色标记_颜色指针_images/fad8bf93.png)
G1 CMS对比
![](.z_4_内存管理_03_gc_垃圾回收器_CMS_G1_ZGC_卡表_读屏障_写屏障_三色标记_颜色指针_images/7f729b7b.png)
内存保护陷阱
![](.z_4_内存管理_03_gc_垃圾回收器_CMS_G1_ZGC_卡表_读屏障_写屏障_三色标记_颜色指针_images/a0ff0e04.png)
颜色指针
![](.z_4_内存管理_03_gc_垃圾回收器_CMS_G1_ZGC_卡表_读屏障_写屏障_三色标记_颜色指针_images/17821ad1.png)
虚拟地址映射
![](.z_4_内存管理_03_gc_垃圾回收器_CMS_G1_ZGC_卡表_读屏障_写屏障_三色标记_颜色指针_images/a33a84d7.png)
![](.z_4_内存管理_03_gc_垃圾回收器_CMS_G1_ZGC_卡表_读屏障_写屏障_三色标记_颜色指针_images/5df0f6f4.png)
ZGC阶段
![](.z_4_内存管理_03_gc_垃圾回收器_CMS_G1_ZGC_卡表_读屏障_写屏障_三色标记_颜色指针_images/3d47c6e0.png)
颜色指针
每个对象都有颜色指针,每个对象的颜色指针状态可能不同
remapped:上次存活且发生复制转移(本次未被标记为m1,将被回收),
m0上次存活且未发生复制转移(本次未被标记为m1，将被回收),
m1本次存活的对象,
![](.z_4_内存管理_03_gc_垃圾回收器_CMS_G1_ZGC_卡表_读屏障_写屏障_三色标记_颜色指针_images/0c9d7b05.png)
#分类
...
[](https://codeantenna.com/a/LkvqQ8aE6Q)
##gc标记
