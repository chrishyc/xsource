...
public final class T23_Threadlocal {
  ...
  private ThreadLocal<List<String>> myThreadLocal1 = ThreadLocal
      .withInitial(() -> Lists.newArrayList("hello"));
  ...
  public static class MyRunnable implements Runnable {
    ...
    public void run() {
      System.out
          .println(Thread.currentThread().getName() + ":before:threadLocal:" + threadLocal.get());
      ...
      System.out
          .println(Thread.currentThread().getName() + ":after:threadLocal:" + threadLocal.get());
