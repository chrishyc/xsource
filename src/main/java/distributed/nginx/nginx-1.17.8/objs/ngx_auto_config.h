#define NGX_CONFIGURE " --add-module=/Users/chris/xsource/src/main/java/distributed/nginx/ngx_http_consistent_hash-master"

#ifndef NGX_COMPILER
#define NGX_COMPILER  "clang 10.0.1 (clang-1001.0.46.4)"
#endif
