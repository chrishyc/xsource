...
不是针对同一个个体有限次尝试必然出事，而是从统计全集（大样本）视角：
只要该负面事件 P＞0（概率不为 0），在足够大量重复试验、足够多的人、足够长时间的全集里面，该坏结果迟早会出现至少一次。
只要存在漏洞 / 坏的可能性，就假定该坏场景终会在某个场景下出现，提前做防御，而不是赌运气 “我应该不会遇上”。
```
```
3. 期望值 E = 概率 × 收益 − 概率 × 损失
...
## 做决策
### 机会成本
机会成本用来卡底线，不用来估上限；优势赛道看能力圈与复利，机会成本仅做风险兜底校验。
机会成本不是客观真实发生的会计成本，它是认知层面的估算值；只能判断方向、量级，无法算出精确客观损失。
机会成本：只做兜底风险评估；自身优势方向，不适合用机会成本做评估
机会成本适合：评估放弃选项带来的兜底损失、下行风险
机会成本不适合：用来测算、否定自己优势赛道的潜在上限收益
```
列出Top2‑3 个最有竞争力的备选方案，不用穷举全部；
定性对比：如果我选 A，我大概率会损失哪一类收益？是金钱？时间成长？身心健康？

一、什么时候适合用机会成本：兜底风险评估
适用场景：判断一个选择，最坏情况下我会失去什么，做风险底线校验。

二、为什么优势方向，不应该用机会成本评估
你的优势赛道，存在非线性复利、能力圈放大效应，它的未来收益是厚尾分布：大概率普通，小概率爆发
```
### 局部最优解和全局最优解
```
什么时候选用局部最优？什么时候追求全局最优？
局部最优:
1.全局最优的收益增量很小，但代价巨大
2.系统是迭代演进的，允许后续迭代修正

全局最优:
1.错误代价极大，局部最优会带来毁灭性损失
2.一次性重大不可逆决策，没有迭代重来机会
```
### 决策树思维
...
### 沉没成本
沉没成本是指已经产生并且无法回收的成本，这个成本不仅仅指钱等具体实物成本，还包括时间、机会、精力等无形成本。沉没成本一旦产生，是无法回收的。
### 快慢思维双系统

### 损失厌恶理论
人们面临同样数量的收益和损失时，通常感觉损失更加让人难以忍受。损失带来的负效用往往是收益正效用的两倍以上

### 不平衡性思维
由于资源有限、系统正反馈放大初始差异、外部环境本身不均，均衡只是短暂状态，不平衡是复杂系统常态；差异会制造势能，既产生套利机遇，也暗藏格局反转的风险，不能静态看待差距
[todo找一些书籍查看]
[todo找一些swot书籍]
### 隐含前提模型
### 六顶帽子思维模型
...
### 风险概率思维
为了得到对自己不重要的东西，甘愿拿对自己重要的东西去冒险，我不管失败的概率是百分之一还是千分之一，我都不做这样的事。

### 认知资源思维模型
[相关书籍]

### 分阶段思维
这个模型鼓励我们从短期、中期和长期的角度来看待我们的行动和决策，从而做出更全面和可持续的选择。
### 关注“重要”任务，忽略“紧急”任务
埃森豪威尔矩阵
### 做出可逆的决策
区分可逆和不可逆的决策，帮助我们更快速地采取行动。
做出更多可逆的决策。你是对是错都没关系，反正你也不会有什么损失，还能获取信息，
如果结果证明你做出了正确／最佳决策，你就能先人一步。最坏的情况也不过是回到原点，这其实也不太坏
了解可逆和不可逆决策之间的差异，可以决定你生活的节奏和势头。如果你偏向可逆的决策，就会不断地行动和学习，不会过度分析或陷入分析瘫痪。
### 遗憾最小化框架
用于就决策问题征询未来的你
1. 想象你自己已经80岁了。
...
## 看问题
### 边际效用
通常来说，如果你不努力，就不会取得任何成果。但同样，持续加大努力并不代表你获得的收益会相应增加，与投入的努力成正比
...
### 90%时间定义问题
### 专家思维为主&新手思维为辅
核心逻辑：用专家做判断、定框架、控风险；用新手视角找盲区、补体感、防惯性盲点，二者不是对半分，权重：专家 70‑80%，新手 20‑30%

### 第一性原理

### 最少假设的解释最有可能是正确的
你从事一项任务，其中80%的成果是由20%的活动和努力产生的。80%的利润是由20%的任务创造。你得到的80%的幸福感来自20%的照片。一个项目80%的成功来自20%的任务。你生活中80%的问题来自20%的人。你80%穿的是衣柜里20%的衣服。
帕累托法则适用于人类体验的每个方面：我们的工作、人际关系、职业生涯、成绩、嗜好和兴趣爱好。大多数事情都符合帕累托分布，投入和产出的比率是相当倾斜的。我们要做的是实现最佳的投入产出比。
### 二八定律

### 多维价值评估
价值指数思维模型是一种用于评估和比较不同选项或决策的工具，主要应用于经济、金融、市场研究等领域。它通过定量分析的方式，帮助决策者更直观地理解这些因素的相对重要性和影响。

### 反向失败思维
反向失败思维模型，是一种通过分析可能导致失败的因素，从而制定策略避免失败的思维方法。这种方法强调从相反的角度思考问题，以识别和解决潜在的风险和问题。

### 逆向思维模型
问自己：“为了达到这个目标，需要哪些前提条件？哪些步骤是必须的？”基于逆向推理的结果，制定解决方案，并设计具体的行动计划。
[todo博弈论书籍]
[todo 反脆弱：从不确定性中受益]
### 马斯洛需求层次
