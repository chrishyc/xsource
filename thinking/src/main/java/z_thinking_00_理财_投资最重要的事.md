...
## 价值回归
## 高增长≠高收益
中国 GDP 增速全球顶尖，但 1988-2012 年 A 股美元年化收益为负（受汇率、估值波动影响），完全符合 “高增长≠高收益” 的规律

## 金本位->纸币本位
货币控制的主导权已经从黄金转向政府。伴随着这一转变，政府总是能够提供充分的流动性，从而保持价格不会下跌
...
# 常见价值评估指标
静态PE, PE(TTM) 加权PE(TTM) 等权PE PB(LF) PS(TTM)
...
[静态PE]
当前股价/上一年完整年报每股收益，用去年全年赚的钱来算现在贵不贵，数据太旧，不准确

[PE(TTM)滚动市盈率]
TTM=过去12个月，当前股价/最近四个季度赚的钱，最近一年真实赚的利率，光伏，消费主要看这个

[加权PE(TTM)]
按公司市值大小算平均，龙头权重大，机构，基金用的就是这个

[等权PE]
所有股票等权，不管大小，亏损多的公司会失真
...
## β系数和α系数
系统性风险（β）：不可分散。来自宏观经济、利率、政策、大盘情绪等整体风险。
非系统性风险（α 相关）：可分散。公司自身经营、行业、暴雷等个股风险

β 只衡量前者：你买任何股票，都天然承担 “大盘涨跌” 的风险，β 就是这个风险的大小刻度。

β = 股票跟大盘同步波动的强度 ÷ 大盘波动强度


高 β（>1.2）：科技、新能源、券商、军工、周期品（弹性大、进攻性强）。
中 β（0.8–1.2）：大部分制造、金融、消费龙头。
低 β（0.5–0.8）：公用事业、电力、高速公路、必需消费（防御、抗跌）
...
→ α = +3%：你跑赢了市场，赚了超额收益
```
[传统 β]:按市值加权（谁大买谁）只赚市场平均收益

[聪明 β]:按因子 / 规则选股、加权（如高股息、低波动、低估值），例如红利低波
