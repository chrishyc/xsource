...
适用场景:亲密关系吵架争论,要求别人做事

所有人一切行为，都是尝试满足自身普世人类需要；冲突只发生在【策略层面】，而非【需要层面】。

他人行为不直接制造你的情绪；情绪由「你解读事件 + 你的需要是否被满足」共同生成（情绪责任归自己，不归对方）
需要是全人类共通（尊重、安全感、自主、理解、归属等）；满足需要的手段 = 策略，策略千差万别、有优劣、有伤害性
评判、指责、道德定罪，本质是策略匮乏：我们找不到看见彼此需要的方式，只能用对抗手段索取需要。
[观察 → 感受 → 需要 → 请求]
# 非暴力沟通四要素
...
为啥过多的道德评判会引来暴力？[对别人道德评价相当于直接否定别人,而不是就事论事,否定别人只会引来别人的仇恨]
## 过多进行比较
